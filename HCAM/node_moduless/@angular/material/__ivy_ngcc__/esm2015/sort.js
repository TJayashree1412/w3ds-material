...
MatSortHeader.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MatSortHeader, selectors: [["", "mat-sort-header", ""]], hostVars: 3, hostBindings: function MatSortHeader_HostBindings(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵlistener("@arrowPosition.start", function MatSortHeader_Template_div_animation_arrowPosition_start_3_listener($event) { return ctx._disableViewStateAnimation = true; })("@arrowPosition.done", function MatSortHeader_Template_div_animation_arrowPosition_done_3_listener($event) { return ctx._disableViewStateAnimation = false; });
